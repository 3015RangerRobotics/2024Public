...
public class Meat extends AutoCommand {
  ...
  public Meat() {
    path1 = PathPlannerPath.fromChoreoTrajectory("Meat.1");
    path2 = PathPlannerPath.fromChoreoTrajectory("Meat.2");
    path3 = PathPlannerPath.fromChoreoTrajectory("Meat.3");
    path4 = PathPlannerPath.fromChoreoTrajectory("Meat.4");
    path5 = PathPlannerPath.fromChoreoTrajectory("Meat.5");
    path6 = PathPlannerPath.fromChoreoTrajectory("Meat.6");
    path7 = PathPlannerPath.fromChoreoTrajectory("Meat.7");
    path8 = PathPlannerPath.fromChoreoTrajectory("Meat.8");
