...
public class LocalADStarAK implements Pathfinder {
  ...
  private long startTime = Logger.getRealTimestamp();
  ...
  public PathPlannerPath getCurrentPath(PathConstraints constraints, GoalEndState goalEndState) {
    ...
    if (io.currentPathPoints.size() < 5) {
      return null;
    }

    long pathIterationTime = Logger.getRealTimestamp() - startTime;
    Logger.recordOutput("PathfinderIterationTimeMS", (pathIterationTime / 1000.0));
